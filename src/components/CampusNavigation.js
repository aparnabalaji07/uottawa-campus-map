...
export default function CampusNavigation() {
  ...
  const getDirections = async () => {
    ...
    try {
      const response = await fetch('https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=AIzaSyAK12w41RsgRBTy22lk4-40qaZK2a-h0ww', {
        method: 'POST',
        headers: {
